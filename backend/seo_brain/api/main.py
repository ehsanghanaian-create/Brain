...
from .routers import ai, ai_config, ai_gateway, ai_workspace, content, content_plans, generation, graph, health, jobs, keywords, links, memory, sites, tracker, traffic
...
def create_app() -> FastAPI:
    ...
    for r in (sites.router, sites.gsc_router, google_router_mod.router, graph.router, memory.router, ai.router, ai_config.router, jobs.router, keywords.router, content.router, links.router, ai_gateway.router, generation.router, content_plans.router, ai_workspace.router, traffic.router):
