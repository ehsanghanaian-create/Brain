...
try {
 ...
 $handlerPos=strpos($render,'RewriteRule ^_ead_blocked\\.php$ - [END]');
 ok($handlerPos!==false && $handlerPos<strpos($render,'RewriteCond %{REMOTE_ADDR} ^8\\.8\\.4\\.4$'),'403 handler must precede IP deny');
