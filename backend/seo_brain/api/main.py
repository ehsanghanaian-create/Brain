...
from .routers import ai, ai_config, ai_gateway, content, content_plans, generation, graph, health, jobs, keywords, links, memory, sites
...
def create_app() -> FastAPI:
    ...
    for r in (sites.router, sites.gsc_router, graph.router, memory.router, ai.router, ai_config.router, jobs.router, keywords.router, content.router, links.router, ai_gateway.router, generation.router, content_plans.router):
