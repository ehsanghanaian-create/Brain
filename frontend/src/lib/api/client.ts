...
export type ProviderKind = { kind: string; label: string; base_url: string; models: string[]; needs_key: boolean; is_gateway?: boolean; setup?: { console_url: string; key_prefix: string; docs: string; fa: string } };
