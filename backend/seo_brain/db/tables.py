...
content_categories = Table(
    "content_categories", metadata,
    Column("id", Integer, primary_key=True, autoincrement=True),
    Column("site_id", String, nullable=False),
    Column("source", String, nullable=False, server_default='wordpress'),
    Column("wordpress_category_id", Integer),
    Column("parent_id", Integer),
    Column("name", String, nullable=False),
    Column("slug", String),
    Column("url", String),
    Column("description", Text),
    Column("post_count", Integer, nullable=False, server_default='0'),
    Column("page_count", Integer, nullable=False, server_default='0'),
    Column("keyword_count", Integer, nullable=False, server_default='0'),
    Column("plan_count", Integer, nullable=False, server_default='0'),
    Column("coverage_score", Float),
    Column("intelligence", Text, nullable=False, server_default='{}'),
    Column("metadata", Text, nullable=False, server_default='{}'),
...
content_clusters = Table(
    ...
    Column("name", String, nullable=False),
    Column("slug", String),
    Column("pillar_plan_id", Integer),
    Column("keyword_cluster_id", String),
    Column("topic", String),
...
content_plans = Table(
    ...
    Column("slug", String),
    Column("intent", String),
    Column("serp_intent", String),
    Column("page_type", String),
    Column("funnel_stage", String),
    Column("category_id", Integer),
    Column("category_suggested_id", Integer),
    Column("category_reason", Text),
    Column("primary_keyword_id", Integer),
    Column("primary_keyword", String),
    Column("secondary_keywords", Text, nullable=False, server_default='[]'),
    Column("heading_structure", Text, nullable=False, server_default='[]'),
    Column("seo_title", String),
    Column("meta_description", Text),
    Column("topic_id", String),
    Column("cluster_id", String),
    Column("content_cluster_id", Integer),
    Column("search_volume", Integer),
    Column("keyword_difficulty", Float),
    Column("priority", String),
    Column("priority_score", Float),
    Column("ai_priority", Float),
    Column("business_value", Float),
    Column("traffic_opportunity", Float),
    Column("content_gap", String),
    Column("cannibalization_risk", Float),
    Column("cannibalization", Text, nullable=False, server_default='[]'),
    Column("ranking_url", String),
    Column("ranking_position", Float),
    Column("target_audience", String),
    Column("publish_date", String),
    Column("publish_time", String),
    Column("status", String, nullable=False, server_default='planned'),
    Column("existing_pages", Text, nullable=False, server_default='[]'),
    Column("link_targets", Text, nullable=False, server_default='[]'),
    Column("graph_connections", Integer, nullable=False, server_default='0'),
    Column("content_score", Float),
    Column("recommendation_id", Integer),
    Column("recommendation", Text, nullable=False, server_default='{}'),
    Column("publishing", Text, nullable=False, server_default='{}'),
    Column("metadata", Text, nullable=False, server_default='{}'),
    Column("notes", Text),
    Column("source", String),
    Column("created_by", String),
...
content_plan_keywords = Table(
    "content_plan_keywords", metadata,
    Column("content_plan_id", Integer, primary_key=True),
    Column("keyword_id", Integer, primary_key=True),
    Column("site_id", String, nullable=False),
    Column("role", String, nullable=False, server_default='secondary'),
    Column("source", String),
    Column("score", Float),
    Column("created_at", String, nullable=False),
)

content_plan_events = Table(
    "content_plan_events", metadata,
    Column("id", Integer, primary_key=True, autoincrement=True),
    Column("site_id", String, nullable=False),
    Column("content_plan_id", Integer, nullable=False),
...
content_plan_imports = Table(
    "content_plan_imports", metadata,
    Column("id", Integer, primary_key=True, autoincrement=True),
    Column("site_id", String, nullable=False),
    Column("source", String, nullable=False, server_default='file'),
    Column("source_id", Integer),
    Column("filename", String),
    Column("format", String),
    Column("rows_total", Integer, nullable=False, server_default='0'),
    Column("rows_created", Integer, nullable=False, server_default='0'),
    Column("rows_updated", Integer, nullable=False, server_default='0'),
    Column("rows_skipped", Integer, nullable=False, server_default='0'),
    Column("errors", Text, nullable=False, server_default='[]'),
    Column("mapping", Text, nullable=False, server_default='{}'),
    Column("dry_run", Integer, nullable=False, server_default='0'),
    Column("created_at", String, nullable=False),
)

content_plan_sources = Table(
    "content_plan_sources", metadata,
    Column("id", Integer, primary_key=True, autoincrement=True),
    Column("site_id", String, nullable=False),
    Column("kind", String, nullable=False, server_default='google_sheet'),
    Column("name", String, nullable=False),
    Column("url", Text),
    ...
    Column("range", String),
    Column("mapping", Text, nullable=False, server_default='{}'),
    Column("key_columns", Text, nullable=False, server_default='["url","primary_keyword","title"]'),
    Column("enabled", Integer, nullable=False, server_default='1'),
    Column("auto_sync", Integer, nullable=False, server_default='0'),
    Column("status", String),
    Column("last_sync_at", String),
    Column("last_result", Text, nullable=False, server_default='{}'),
    Column("created_at", String, nullable=False),
    Column("updated_at", String, nullable=False),
)

content_plan_recommendations = Table(
    "content_plan_recommendations", metadata,
    Column("id", Integer, primary_key=True, autoincrement=True),
    Column("site_id", String, nullable=False),
    Column("plan_id", Integer),
    ...
    Column("version", Integer, nullable=False, server_default='1'),
    Column("status", String, nullable=False, server_default='new'),
    Column("engine", String, nullable=False, server_default='rules-v1'),
    Column("computed_at", String, nullable=False),
    Column("decided_at", String),
    Column("decided_by", String),
)

content_plan_generation_jobs = Table(
    "content_plan_generation_jobs", metadata,
    Column("id", Integer, primary_key=True, autoincrement=True),
    Column("site_id", String, nullable=False),
    Column("plan_id", Integer, nullable=False),
    Column("content_item_id", Integer),
    Column("generation_run_id", String),
    Column("draft_id", Integer),
    Column("kind", String, nullable=False, server_default='article'),
