...
from .routers import ads_data, ai, ai_config, ai_gateway, ai_workspace, content, content_plans, generation, graph, health, jobs, keywords, knowledge, links, memory, portfolio, site_security, sites
...
def create_app() -> FastAPI:
    ...
    for r in (portfolio.router, ads_data.router, sites.router, sites.gsc_router, google_router_mod.router, graph.router, memory.router, knowledge.router, site_security.router, ai.router, ai_config.router, jobs.router, keywords.router, content.router, links.router, ai_gateway.router, generation.router, content_plans.router, ai_workspace.router):
